...
module.exports = app => {
  ...
  app
    .route("/api/spots/:spotId")
    .get(spotResource.getOne)
    .put(spotResource.update)
    .delete(spotResource.delete);

  app.route("/api/reviews/").post(reviewResource.create);

  app.route("/api/reviews/:spotId").get(reviewResource.getMany);

  app.route("/api/users/").post(userResource.create);

  app.route("/api/users/login").post(userResource.login);

  app.route("/api/menu/").post(menuResource.create);

  app.route("/api/menu/:spotId").get(menuResource.getMany);

  app
    .route("/api/menu/:menuId")
    .put(menuResource.update)
    .delete(menuResource.delete);
};
