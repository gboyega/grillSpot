...
const displaySearchResults = (sortedSpot, i) => {
  ...
  card = ` <div class="card" value="${spot.uId}">
                    <img src="${spot.img}"
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            <span href="#" class="badge badge-success text-dark">${spot.location}</a>
                            <span href="# class="badge badge-dark text-success">${spot.category}</a>
                        </p>
                    </div>
