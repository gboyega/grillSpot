...
const displaySearchResults = (sortedSpot, i) => {card = ` <div class="card">
                    <img src="https://res.cloudinary.com/gboyega/image/upload/v1574855909/grillspot/IMG_0660_zutyzp.jpg"
                        class="card-img-top" alt="suya">
                    <div class="card-body">
