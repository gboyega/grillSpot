...
const displaySearchResults = (sortedSpot, i) => {
  ...
  card = ` <div class="card" id="${spot.uId}">
                    <img src="${spot.img}"
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            <a href="#" class="badge badge-success text-dark">${spot.location}</a>
                            <a href="#" class="badge badge-dark text-success">${spot.category}</a>
                        </p>
                    </div>
                    <div class="card-footer">
                        <small class="text-muted">${spot.category} reviews</small>
                    </div>
                </div>`;
